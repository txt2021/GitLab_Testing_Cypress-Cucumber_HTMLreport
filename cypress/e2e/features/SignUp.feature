...
Scenario Outline: TC02 - Should sign up on GitLab with invalid credentials
        Given A user open main GitLab page
        When A user clicks on "Support" button
        When A user clicks on "Register1"
        When A user enters "Tester" in "First name" field
...
Scenario Outline: TC03 - Should sign up on GitLab with empty credentials
        Given A user open main GitLab page
        When A user clicks on "Support" button
        When A user clicks on "Register1"
        When A user clicks on "Register2"
...
Scenario Outline: TC04 - Should sign up on GitLab with Saleforce
        Given A user open main GitLab page
        When A user clicks on "Support" button
        When A user clicks on "Register1"
